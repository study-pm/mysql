...
INSERT INTO client(last_name, first_name, second_name, passport_number, birth_date, address, comment) 
    ...
    ('Агафонов', 'Валерий', 'Борисович', '6349197041', '1941-03-10', 'ул. Марата, д. 9, г. Курск, Курская обл., 305000', 'певец'),
    ...
    ('Соловьев', 'Владимир', 'Рудовольфович', '5679546321', '1963-10-20', 'наб. Варкауса, д. 1А, г. Петрозаводск, Республика Карелия, 185031', 'российский журналист, радио- и телеведущий'),
    ...
    ('Просов', 'Владимир', 'Тимофеевич', '1998653478', '1991-03-03', 'Мясницкий проезд, д. 4, стр. 1, г. Москва, 107078', NULL)
;
...
INSERT INTO checkin(date_ts, enter_date, leave_date, room_id, client_id) VALUES
    ...
    ('2023-12-12', '2023-12-12', '2024-01-01', 14, 23),
    ('2024-04-05', '2024-04-05', '2024-05-01', 7, 14),
    ('2018-01-02', '2018-01-02', '2018-04-28', 13, 23),
