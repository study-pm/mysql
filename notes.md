...
![Типовая организация СУБД](./img/dbms-architecture.png)

**Типовая организация СУБД**

![Основные компоненты СУБД](./img/dbms-components.png)
