...
- [Тема 2.4 СУБД MySQL](#тема-24-субд-mysql)
  - [Описание MySQL](#описание-mysql)
    ...
    - [Распространение MySQL и сферы применения](#распространение-mysql-и-сферы-применения)
    ...
    - [Итоги](#итоги)
  - [Описание MySQL](#описание-mysql-1)
    - [Кто пользуется MySQL](#кто-пользуется-mysql)
    - [Для чего нужна MySQL](#для-чего-нужна-mysql)
    - [Как устроена база данных MySQL](#как-устроена-база-данных-mysql)
    - [Преимущества MySQL](#преимущества-mysql-1)
    - [Недостатки MySQL](#недостатки-mysql-1)
...
#### Распространение MySQL и сферы применения
...
### Описание MySQL
[6734fe345040133e8429e646](https://e-learn.petrocollege.ru/mod/url/view.php?id=282880)
