...
- [Тема 1.7 Методы организации целостности](#тема-17-методы-организации-целостности)
  ...
  - [Декларативные  ограничения целостности](#декларативные--ограничения-целостности)
    - [Целостность таблиц](#целостность-таблиц)
    - [Целостность столбцов](#целостность-столбцов)
    - [Целостность связей между таблицами](#целостность-связей-между-таблицами)
    - [Целостность связей между столбцами](#целостность-связей-между-столбцами)
  - [Динамические ограничения целостности](#динамические-ограничения-целостности)
...
1. **Уникальность значений столбца**:
...
2. **Значение по умолчанию** – это то значение, которое принимает столбец конкретной строки, если при вводе этой строки значение данного столбца отсутствует (`NULL`).

3. **Условия на значения столбца**: можно задать условие на допустимость значений столбца.

4. **Домен как тип данных**. **Домен** – именованное описание множества допустимых значений столбцов. **Домен** – это объект базы данных, который можно создать, переопределить и уничтожить. При определении столбца вместо его типа можно указывать домен.
