...
- [Тема 2.1 Архитектуры баз данных](#тема-21-архитектуры-баз-данных)
  - [Архитектура распределенной обработки данных](#архитектура-распределенной-обработки-данных)
    - [Базовые архитектуры распределенной обработки](#базовые-архитектуры-распределенной-обработки)
      - [Модель «файл-сервер» в технологии БД](#модель-файл-сервер-в-технологии-бд)
      - [Двухуровневые архитектура «клиент-сервер»](#двухуровневые-архитектура-клиент-сервер)
      - [Архитектура «активный сервер баз данных»](#архитектура-активный-сервер-баз-данных)
      - [Архитектура сервера приложений](#архитектура-сервера-приложений)
      - [Архитектура сервера баз данных](#архитектура-сервера-баз-данных)
      ...
      - [Архитектура клиент-сервер для WEB](#архитектура-клиент-сервер-для-web)
...
Почти все модели организации взаимодействия пользователя с БД, построены на основе модели «клиент-сервер». Т.е. предполагается, что каждое такое  приложение отличается способом распределения функций обработки данных (смотри слайд 6) между как минимум двумя частями:
...
##### Двухуровневые архитектура «клиент-сервер»
...
Эта модель является расширением двухуровневой модели и в ней вводится дополнительный промежуточный уровень между клиентом и сервером. *Архитектура* трехуровневой модели приведена на рисунке. Этот промежуточный уровень содержит один или несколько серверов приложений.
